...
{
    public const int CurrentCharacterSchemaVersion = 1;
    public const int MinSupportedCharacterSchemaVersion = 1;

    public const int CurrentEncounterSchemaVersion = 1;
    public const int MinSupportedEncounterSchemaVersion = 1;
