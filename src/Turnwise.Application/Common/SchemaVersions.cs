...
public static class SchemaVersions
{
    ...
    /// Combatant.TemporaryHp, adding Counter.Category, and adding Combatant.MaxHpFormula. All are
    /// safe for files at <see cref="MinSupportedCharacterSchemaVersion"/>: dropped fields are
    /// simply ignored on load, and new fields come back empty/zero.
    /// </summary>
    public const int CurrentCharacterSchemaVersion = 7;
    ...
    public const int CurrentEncounterSchemaVersion = 9;
